...
I am a superb  Group Moderator Bot and I will help in managing your group
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add MEWTWO 3.0 BOT to your group 💫",
...
Support them  [N](t.me/teamishere,[MEWTWO BOT](t.me/mewtwo1_botsupport),"""
...
def LEGEND_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n 🔥 Join [Mewtwo 3.0 Support](https://t.me/mewtwo1_botsupport) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on Swami](https://github.com/pogonoob)."
            f"\n\n{dispatcher.bot.first_name}'s source code was rewritten by @Swami_2_0_0_5"
